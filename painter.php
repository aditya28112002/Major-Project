    ...
    <div class="container">
        <div class="row mb-5">
            <div class="mt-5 mt-lg-0 text-center text-lg-start order-lg-0 order-1 col-12 col-md-12 col-lg-6 d-flex flex-column justify-content-center align-items-center">
                <h1 class="text-capitalize fw-bolder text-white">Painters</h1>
                <p class="mt-3 mb-5 para-width text-light-grey">Discover the experience of the best painters with ServiceCare essentials, meticulously designed to elevate your workspace. We offer a comprehensive range of stationery and furniture products that combine functionality with aesthetic appeal and professional.</p>
            ...
            <div class="col-12 col-md-12 col-lg-6 order-lg-1 order-0">
                <div class="text-center text-lg-end">
                    <img id="img-set-house" src="img/painters.jpg" alt="painters" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
...
<!-- Painters List Section -->
<section id="painter-list" class="bg-light py-5">
    <div class="container">
        <h2 class="text-center mb-4">Meet Our Painters</h2>
        <div class="row">
            <?php
            // Fetch approved painters from the database
            $sql = "SELECT * FROM providers WHERE service_type = 'Painter'";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                // Output each painter as a card from database
                    ...
                    echo '<div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="booking-form.html?painter=' . urlencode($row['full_name']) . '" class="btn btn-primary">Book Now</a>
                                </div>
                            </div>
                        </div>';
                }
            } else {
                echo '<p class="text-center">No Painters available at the moment. Please check back later!</p>';
            }
            ?>
        </div>
    </div>
