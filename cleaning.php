        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-5 mt-lg-0 text-center text-lg-start order-lg-0 order-1 col-12 col-md-12 col-lg-6 d-flex flex-column justify-content-center align-items-center">
                    <h1 class="text-capitalize fw-bolder text-white">Cleaners</h1>
                    <p class="mt-3 mb-5 para-width text-light-grey">Discover the excellence of cleaning with ServiceCare essentials, meticulously designed to elevate your workspace. We offer a comprehensive range of stationery and furniture products that combine functionality with aesthetic appeal and professional.</p>
                ...
                <div class="col-12 col-md-12 col-lg-6 order-lg-1 order-0">
                    <div class="text-center text-lg-end">
                        <img id="img-set-house" src="img/Cleaner.png"
                            alt="Cleaner" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section id="cleaner-list" class="bg-light py-5">
    <div class="container">
        <h2 class="text-center mb-4">Meet Our Cleaners</h2>
        <div class="row">
        <?php
            // Fetch approved electricians from the database
            $sql = "SELECT * FROM providers WHERE service_type = 'Cleaner'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p class="text-center">No Cleaners available at the moment. Please check back later!</p>';
            }
            ?>
