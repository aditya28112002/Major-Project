...
?>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="mt-5 mt-lg-0 text-center text-lg-start order-lg-0 order-1 col-12 col-md-12 col-lg-6 d-flex flex-column justify-content-center align-items-center">
                    <h1 class="text-capitalize fw-bolder text-white">Cabs and Packagers</h1>
                ...
                <div class="col-12 col-md-12 col-lg-6 order-lg-1 order-0">
                    <div class="text-center text-lg-end">
                        <img id="img-set-house" src="img/packers.webp"
                            alt="cabs&Packers" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Cab Drivers List Section -->
<section id="cab-driver-list" class="bg-light py-5">
    <div class="container">
        <h2 class="text-center mb-4">Meet Our Cab Drivers</h2>
        <div class="row">
        <?php
            // Fetch approved electricians from the database
            $sql = "SELECT * FROM providers WHERE service_type = 'Cabs'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p class="text-center">No Cab Driver available at the moment. Please check back later!</p>';
            }
            ?>
             <?php
            // Fetch approved electricians from the database
            $sql = "SELECT * FROM providers WHERE service_type = 'Packagers'";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p class="text-center">No Packagers available at the moment. Please check back later!</p>';
            }
            ?>
        </div>
    </div>
